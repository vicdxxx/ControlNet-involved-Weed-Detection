...
model.load_state_dict(load_state_dict(r'D:\BoyangDeng\StableDiffusion\ControlNet\lightning_logs_crop1000_resize640\version_1\checkpoints\epoch=54-step=141899.ckpt', location='cuda'))
model = model.cuda()
